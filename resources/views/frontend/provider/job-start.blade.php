    ...
    <div class="container">
      ...
      <div class="provider-circle">
        <svg width="150" height="150">
          ...
          <circle cx="80" cy="80" r="62" class="progress-start"></circle>
        </svg>
      ...
      <div class="provider-service-card">
        ...
        <!-- OTP -->
        <h6>Enter OTP to Start Service</h6>
        <p class="muted small">
          Request the OTP from the customer to begin the service.
        </p>

        <div class="provider-otp">
        ...
        <div class="provider-actions">
          ...
          <a href="{{ route('provider.job.inprogress') }}" class="start">Start Service</a>
        </div>
      </div>
    </div>
  </section>
