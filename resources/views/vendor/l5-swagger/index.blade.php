...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('assets/img/favicon/fav.png') }}" sizes="32x32"/>
    <link rel="icon" type="image/png" href="{{ asset('assets/img/favicon/fav.png') }}" sizes="16x16"/>
    <style>
    html
    {
...
<body @if(config('l5-swagger.defaults.ui.display.dark_mode')) id="dark-mode" @endif>
    <div style="padding: 10px; display: flex; align-items: center; background:linear-gradient(20deg, #1B5E20, #5aad60);">
        <img src="{{ asset('assets/img/logo.png') }}" alt="Logo" height="40" style="margin-right: 10px;">
    </div>
...
<script>
    ...
    window.onload = function() {
        {{--  $("#swagger-ui .topbar").addClass('d-none');  --}}
        const urls = [];
