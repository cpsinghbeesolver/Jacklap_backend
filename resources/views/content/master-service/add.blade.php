...
@section('title', 'Add Master Service')

@section('content')
<div class="row">
<div class="col-12">

<form method="POST" action="{{ route('master-service.store') }}">
@csrf
...
<div class="col-md-6">
    <div class="form-floating form-floating-outline">
      <input type="number" id="price_limit" name="price_limit" class="form-control  @error('price_limit') is-invalid @enderror" value="{{ old('price_limit') }}">
